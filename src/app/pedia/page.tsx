...
const ARTICLES = [
  ...
  { href: "/pedia", icon: "🐔", titleKey: "pedia.breeds.title", descKey: "pedia.breeds.desc", live: false },
  { href: "/pedia", icon: "⚙️", titleKey: "pedia.mechanics.title", descKey: "pedia.mechanics.desc", live: false },
] as const;
